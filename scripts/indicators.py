...
INDICATORS = {
    ...
    '单方造价元/m²': [
        (['大修', '改造', '维修'], (500, 1500), '大修改造(装饰为主)500-1500; 含结构加固1500-2500', '⚠️通行经验(2026)'),
        (['住宅'], (1500, 3000), '多层砖混1500-2200 / 框架高层2500-3200(毛坯)', '⚠️通行经验(2026)'),
        (['厂房', '仓库'], (1000, 2500), '单层轻钢厂房1200-2000 / 带吊车2000-3000', '⚠️通行经验(2026)'),
        (['办公楼'], (2000, 3500), '框架办公楼2000-3000 / 精装3000-4000', '⚠️通行经验(2026)'),
    ],
}
